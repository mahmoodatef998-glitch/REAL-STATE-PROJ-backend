...
export const CONFIG = {
    ...
    CLOUDINARY_CLOUD_NAME: process.env.CLOUDINARY_CLOUD_NAME || 'dnadpundx',
    CLOUDINARY_API_KEY: process.env.CLOUDINARY_API_KEY || '666869455243947',
    CLOUDINARY_API_SECRET: process.env.CLOUDINARY_API_SECRET || 'QieeiylZOBZIDQeEqQl6MZ7SR_E',
};
